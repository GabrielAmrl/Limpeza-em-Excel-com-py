select
'RJ' as Distribuidora --base_ordens_encerradas
...
where ultima_etapa = true and cluster_ordem = 'INICIATIVA CLIENTE' and status_prazo is not null and ano_encerramento >= '2024' and status_ordem = 'FECHADA') 
group by
